...
func (s *service) SummaryInventoryStockRom(iupopkId int, startDate string, endDate string) (Summary, error) {
	summary, summaryErr := s.repository.SummaryInventoryStockRom(iupopkId, startDate, endDate)
